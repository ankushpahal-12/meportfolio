    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            cards.forEach(card => {
                ...
                card.addEventListener('mouseleave', () => gsap.to(card, { scale: 1, backgroundColor: "rgba(24, 24, 27, 0.4)", duration: 0.3 }));
            });
            ...
            <div className="max-w-7xl mx-auto">
                <GlassCard className="p-8 sm:p-12">
                    <div className="cert-header flex items-center gap-4 mb-6 opacity-0">
                        <div className="p-3 bg-purple-600/10 rounded-xl text-purple-500 border border-purple-500/20 shadow-lg shadow-purple-500/10">
                            <Award size={24} />
                        </div>
                    ...
                    <div className="cert-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {certs.map((cert, index) => (
                            <div
                                ...
                                className="cert-card cursor-pointer bg-zinc-900/40 border border-zinc-800 p-6 rounded-2xl transition-all group flex flex-col justify-between h-full opacity-0 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5"
                            >
                                <div className="mb-4">
