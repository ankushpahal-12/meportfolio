            ...
            */}
                ...
                >
                    ...
                    <div className="hidden md:flex items-center gap-2 pl-4 border-l border-white/10">
                        <Magnetic>
                            <a href="https://github.com/ankushpahal-12" target="_blank" rel="noreferrer" className="p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-full transition-all">
                                <Github size={18} />
                            </a>
                        </Magnetic>
                        <Magnetic>
                            <a href="https://www.linkedin.com/in/pahalankush/" target="_blank" rel="noreferrer" className="p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-full transition-all">
                                <Linkedin size={18} />
                            </a>
                        </Magnetic>
                    </div>
                ...
                >
                    ...
                    <SocialDock orientation="horizontal" className="justify-center mt-4" />
                </div>
