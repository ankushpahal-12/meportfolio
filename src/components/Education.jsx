                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative z-10 group/list">
                        {educationData.map((edu, index) => (
                            ...
                            >
                                ...
                                {/* Content Card */}
                                <div className="p-8 rounded-[2.5rem] bg-[var(--bg-tertiary)] border border-[var(--border-color)] group-hover/card:border-indigo-500/30 transition-all shadow-xl hover:shadow-indigo-500/5 relative overflow-hidden h-full flex flex-col">
                                    {/* Abstract Decoration */}
